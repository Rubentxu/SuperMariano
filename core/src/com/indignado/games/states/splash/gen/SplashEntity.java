 ...
 * ---------------------------------------------------------------------------
 */
public class SplashEntity extends com.ilargia.games.entitas.Entity {

    public SplashEntity(int totalComponents, Stack<IComponent>[] componentPools,
                        EntityMetaData entityMetaData, EventBus<SplashEntity> bus) {
