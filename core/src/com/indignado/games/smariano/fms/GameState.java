package com.indignado.games.smariano.fms;
...
import com.indignado.games.smariano.pantallas.GameScreen;
import com.indignado.games.smariano.pantallas.MenuScreen;
import com.indignado.games.smariano.pantallas.transitions.Transition;
import com.indignado.games.smariano.pantallas.transitions.TransitionFactory;
    ...
    SHOW_NEXT_SCREEN {
        ...
        public void update(BaseGame game) {
            ...
            if (game.currScreen instanceof GameScreen) {
                ...
                game.audioManager.playMusic(game.levelManager.getCurrentLevel().getMusic());
            } else if (game.currScreen instanceof MenuScreen) {
                GameLogger.info("GameState", "music Menu");
                game.audioManager.stopMusic();
                game.audioManager.playMusic(ResourcesManager.MUSIC_MENU);
